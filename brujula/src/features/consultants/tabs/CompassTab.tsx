...
export function CompassTab({ consultant }: { consultant: Consultant }) {
  ...
  const latest = useMemo(
    () =>
      snapshots
        ...
        .sort((a, b) => b.generadoEl.localeCompare(a.generadoEl))[0],
  ...
  const run = () => {
    ...
    createSnapshot.mutate(payload as Partial<CompassSnapshot>)
  }
    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-[12.5px] text-faint">
          Último análisis: {fechaHora(latest.generadoEl)} · el análisis no reemplaza el criterio profesional
        </p>
