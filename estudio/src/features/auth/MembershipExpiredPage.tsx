  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-surface px-6 py-12 text-center">
      ...
      <p className="mt-2 max-w-sm text-[14px] leading-relaxed text-muted-foreground">
        {user?.nombre ? `Hola ${user.nombre}, tu` : 'Tu'} acceso profesional a Método Estudio está pausado hasta
        que se confirme el pago de la membresía anual. Tus estudiantes y todos tus datos (si ya cargaste alguno)
        siguen guardados tal cual — no se pierde nada.
      </p>
